...
N_1 = max(i_left(:)) - min(i_left(:)) + 1; % Længden af diffratkion.
...
N_1 = max(i_right(:)) - min(i_right(:)) + 1; % Længden af diffratkion.
...
N_1 = max(i_top(:)) - min(i_top(:)) + 1; % Længden af diffratkion.
...
N_1 = max(i_bottom(:)) - min(i_bottom(:)) + 1; % Længden af diffratkion.
